  ...
  return (
    <div className="screen review-screen">
      ...
      <div className="review-list">
        {answers.map((ans, i) => {
          const statusType = ans.timedOut ? 'timeout' : ans.correct ? 'correct' : 'wrong';
          const statusLabel = ans.timedOut ? '⏱️ Timed Out' : ans.correct ? '✅ Correct' : '❌ Wrong';
              ...
              <div className="review-answers">
                ...
                {ans.correct && (
                  <div className="review-ans-row">
                    ...
                    <span className="val green">+{ans.pts}</span>
                  </div>
                )}
              </div>
